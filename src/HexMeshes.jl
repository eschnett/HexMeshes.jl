...
include("two_hole.jl")
# 3D `make_two_ball_mesh` (ball with two spherical holes; binary excision).
include("two_ball.jl")
...
export
    ...
    PatchBilinearQuad, PatchTrilinearHex,
    PatchDesc,
    dims, n_elements,
    ...
    make_two_hole_mesh,
    make_cubed_cube_mesh, make_inflated_cube_mesh, make_two_ball_mesh,
